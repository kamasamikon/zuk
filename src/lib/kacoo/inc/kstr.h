...
#if 0
kint kstr_new       /**< new a kstr */
kint kstr_del       /**< del a kstr */

kint kstr_set       /**< set value */
kint kstr_ptr       /**< get real string */
kint kstr_cmp       /**< strncmp */

kchar *kstr_str     /**< convert to kchar */
