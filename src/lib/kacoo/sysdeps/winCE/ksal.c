...
{				// no current work dir concept in WINCE
	return 0;
}
...
{				//UTC, since 1970.1.1.0
	...
	*inTT =
		(time_t) Get1970ToCurSecond(sysTime.wYear, sysTime.wMonth,
				sysTime.wDay, sysTime.wHour, sysTime.wMinute, sysTime.wSecond) - 57600;
#else
	*inTT =
		(time_t) Get1970ToCurSecond(sysTime.wYear, sysTime.wMonth,
...
void SystemTimeToTime_t(SYSTEMTIME *systemTime, time_t *dosTime)
{
	...
	jan1970FT.QuadPart = 116444736000000000 I64;	// january 1st 1970
